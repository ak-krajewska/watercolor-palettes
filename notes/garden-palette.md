...
## Design Principles
- **W&N as backbone** — trusted paints for the known colors (Cad Yellow, Cad Red, Dioxazine Violet, white gouache, earth tones)
- **Szmal for flowers** — higher saturation right out of the pan, good for vivid flower colors (Quin Magenta, Pyrrole Red)
- **Szmal/Holbein for greens** — new territory anyway, worth experimenting (Phthalo Green, Bamboo Green, Cobalt Cerulean)
- **Warm mood** — the garden reads warm even on foggy days; darks are warm browns not cool greys
...
## Sage Colors
Already solved on the default palette with Dioxazine Violet + Cad Red + white gouache. Carried over here.

## Succulents
Complex subject. The powdery/dusty quality may come from Cobalt Cerulean's granulation. Sun-damage reds: Pyrrole Red or Cad Red thinned and mixed into greens. The violet-to-green transitions: Dioxazine Violet into Bamboo Green.

## Earths
Warm earth tones — this is a warm palette intentionally.
- **Yellow Ochre** — can't leave home without it. Warm foliage, dried grasses, stems, terracotta
- **Burnt Sienna** — bark, terracotta pots, warm shadows, organic surfaces
